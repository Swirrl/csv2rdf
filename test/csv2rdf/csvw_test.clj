...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :minimal}))]
    (let [expected-statements (rdf/statements
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/countries.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test032/csv-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test033/csv-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :minimal}))]
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/test034/senior-roles.csv")
                       ...
                       {:body (io/file "csvw_data/test034/gov.uk/schema/professions.json"),
                        :headers {"Content-Type" "application/csvm+json"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test034/csv-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/test035/senior-roles.csv")
                       ...
                       {:body (io/file "csvw_data/test035/gov.uk/schema/professions.json"),
                        :headers {"Content-Type" "application/csvm+json"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test035/csv-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :minimal}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test038-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test039-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test040-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test041-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test042-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test043-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test044-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test045-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test046-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test047-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test048-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test049-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test059-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test060-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test061-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test062-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test063-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test065-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test066-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test067-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test068-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test069-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test070-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test071-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test072-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test073-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test074-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test075-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test076-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test077-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test078-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test079-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test080-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test081-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test082-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test083-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test084-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test085-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test086-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test087-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test088-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test089-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test090-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test093-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test095-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test097-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test098-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test099-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test100-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test101-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test102-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test103-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test104-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test105-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test106-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test107-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test108-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test109-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test110-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test111-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test112-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test113-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test114-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test115-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test125-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test126-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test127-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test128-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test129-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test130-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test131-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test132-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test133-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test134-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test135-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test136-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test137-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test138-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test139-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test140-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test141-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test142-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test143-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test144-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test146-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test147-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test148-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test149-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test150-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test151-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test152-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test153-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test154-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test155-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test156-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test157-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test158-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test159-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test160-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test161-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test162-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test163-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test164-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test165-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test166-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test167-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test168-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test169-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test170-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test171-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test172-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test173-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test174-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test175-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test176-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test177-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test178-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test179-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test180-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test181-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test182-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test183-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test184-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test185-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test186-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test187-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test188-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test189-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test190-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test191-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test192-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test193-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test194-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test195-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test196-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test197-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test198-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test199-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test200-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test201-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test202-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test203-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test204-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test205-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test206-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test207-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test208-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test209-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test210-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test211-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test212-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test213-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test214-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test215-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test216-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test217-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test218-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test219-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test220-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test221-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test222-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test223-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test224-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test225-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test226-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test227-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test228-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test229-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test230-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test231-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test232-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test233-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test234-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test235-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test236-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test237-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :minimal}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test238-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test242-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test243-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test244-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test245-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test246-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test247-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test248-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test251-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test252-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/countries.csv")
                       ...
                       {:body (io/file "csvw_data/country_slice.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test253-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test261-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test263-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test264-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test266-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test267-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test268-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test269-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test270-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/test271.csv")
                       ...
                       {:body (io/file "csvw_data/countries.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test271-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/test272.csv")
                       ...
                       {:body (io/file "csvw_data/countries.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test272-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test273-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test274-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
    nil
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test275-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test276-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test277-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
                      {(URI. "http://www.w3.org/2013/csvw/tests/tree-ops.csv")
                       {:body (io/file "csvw_data/tree-ops.csv"), :headers {"Content-Type" "text/csv"}}})
        csv-uri nil
        metadata-source (io/file "csvw_data/test278-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test279-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test280-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test281-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test282-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test283-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test284-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test285-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test286-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test287-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test288-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test289-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test290-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test291-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test292-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test293-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test294-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test295-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test296-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test297-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test298-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test299-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test300-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test301-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test302-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test303-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test304-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test305-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test306-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]
...
(deftest
  ...
  (let [http-client (->TestHttpClient
        ...
        csv-uri nil
        metadata-source (io/file "csvw_data/test307-metadata.json")
        {:keys [warnings errors result]} (http/with-http-client
                                           http-client
                                           (csvw/csv->rdf csv-uri metadata-source {:mode :standard}))]

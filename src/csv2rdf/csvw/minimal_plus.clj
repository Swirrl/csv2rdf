...
(defmethod table-group-context :minimal-plus [mode table-group]
  {:mode mode
   :statements (optional-annotation-statements table-group)})

(defmethod table-statements :minimal-plus [_context {:keys [url] :as table} annotated-rows]
  (concat
